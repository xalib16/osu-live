...
6. Set `POSTGRES_URL` and `DATABASE_TYPE` if you are using an [external or self-h<osted database](https://github.com/xalib16/osu-live/blob/add-scores-history/server/SETUP_DATABASE.md).
